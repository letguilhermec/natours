...
var displayMap = function displayMap(locations) {
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/letguilhermec/cl7jtcd8x002y14o6mgpd4npe',
    // style URL
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description)).addTo(map); //  Extends the map bounds to include locations
...
var stripe = Stripe('pk_test_51Lg8xrFdWMkD89H77r7pTrH6NSttsOJrAU56G7IuKXkD1IlrHyy8CxplB8VhTxZTGIcp6A3rgnlKVy2gc4qhZbs000gypqmqHH');
